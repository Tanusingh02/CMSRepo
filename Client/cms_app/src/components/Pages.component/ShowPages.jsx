          ...
          <button className="btn btn-danger me-2" onClick={handleDeleteNavigation} disabled={!selectedPageId}>Delete</button>
                  ...
                  <table className="table table-striped">
                    <thead>
                        ...
                        <th scope="col">Page Title <button className="btn btn-sm btn-light ms-1" onClick={handleSortClick}>{sortOrder === 'asc' ? '↑' : '↓'}</button></th>
                    ...
                    <tbody>
                        {pages.map((page)=>
                            <tr>
                                <td><input type="checkbox" checked={selectedPageId===page._id} onChange={()=>handleCheckboxChange(page._id)}></input></td>
