    ...
    <div>
      <MainLayout>
        <div className="d-flex justify-content-center align-items-start min-vh-100 bg-light">
          ...
          >
            <h3 className="text-center mb-4 " style={{ color: " #1f87c2" }}>Update-Data</h3>
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label>Page Title<span className="required-asterisk" style={{color:'red'}}>*</span></label>
                <input
                  type="text"
                  name="page_title"
              ...
              <div className="mb-3 dropdown-wrapper">
                <label>Category<span className="required-asterisk" style={{color:'red'}}>*</span></label>
                <input 
                  type="text"
                  name="category"
                  value={FormData.category}
                  onChange={handleChange}
                  className="form-control not-edit" readOnly />
                <i className="bi bi-caret-down-fill"></i>
              </div>
              <div className="mb-3">
                <label>Content<span className="required-asterisk" style={{color:'red'}}>*</span></label>
                <textarea
                  name="content"
              ...
              <div className="text-center">
                <button type="submit" disabled={!isFormValid} className="btn btn-primary mt-2">Update</button>
                 {!isFormValid && (
                  <small className="text-muted d-block mt-2">Please fill out all fields to enable Update.</small>
                )}
              </div>
            </form>
          </div>
